...
<div class="container text-justify ml-4">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            Специальность: {{ session('user')->spec }}. <br> 
            Вы являетесь: врачом.
        </div>
        <div class="col-md-4">
    ...
    <div class="row mb-4">
        <div class="col-md-4">Контактный телефон: {{ (empty(session('user')->tel)) ? "Не указан" :  session('user')->tel }}.</div>
        <div class="col-md-4">
            Квалификация: {{ session('user')->quality }}.
        </div>
        <div class="col-md-4">
            Номер кабинета: {{ session('user')->cabinet }}
        </div>
    </div>
</div>
</div>
